...
class PopUpStatusMedicalCamp extends StatelessWidget {
  const PopUpStatusMedicalCamp({Key? key}) : super(key: key);
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "You will receive an email shortly regarding the venue for the medical camp.",
                    textScaleFactor: 1.2,
